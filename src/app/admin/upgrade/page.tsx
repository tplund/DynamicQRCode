  ...
  return (
    <div>
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">Upgrade for more QR codes and scans.</p>
      </div>
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-6">
                {isCurrent ? (
                  <span className="inline-block w-full rounded-lg bg-blue-50 px-4 py-2 text-center text-sm font-medium text-blue-700">
                    Current plan
                  </span>
                ) : canUpgrade ? (
                  <button
                    ...
                    className="w-full rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 disabled:opacity-50 transition-colors cursor-pointer"
                  >
